...
{
        #region generated code for Audit
    /// <summary>
    /// Service
    /// Class containing service behaviour for Audit
    /// </summary>
    public partial class UcbService
    {
            #region Behaviour for Audit
            ...
            /// <param name="dc"></param>
            public AuditVMDC CreateAudit(string currentUser, string user, string appID, string overrideID, AuditDC dc)
            {
    			// Create unit of work
                IUnitOfWork uow = new UnitOfWork(currentUser);
    	
    			// Create repository
                Repository<Audit> dataRepository = new Repository<Audit>(uow.ObjectContext, currentUser, user, appID, overrideID);
                ...
                return CreateAudit(currentUser, user, appID, overrideID, dc, dataRepository, uow,exceptionManager, mappingService);
            }
            ...
            /// <param name="overrideID"></param>
            /// <param name="dc"></param>
            public AuditVMDC UpdateAudit(string currentUser, string user, string appID, string overrideID, AuditDC dc)
            {
    			// Create unit of work
                IUnitOfWork uow = new UnitOfWork(currentUser);
    			
    			// Create repository
                IRepository<Audit> dataRepository = new Repository<Audit>(uow.ObjectContext, currentUser, user, appID, overrideID);
    			...
    			// Call overload with injected objects
                return UpdateAudit(currentUser, user, appID, overrideID, dc, dataRepository, uow,exceptionManager, mappingService);
            }
            ...
            /// <param name="dataRepository"></param>
            /// <param name="uow"></param>
            public AuditVMDC UpdateAudit(string currentUser, string user, string appID, string overrideID, AuditDC dc, IRepository<Audit> dataRepository, IUnitOfWork uow,IExceptionManager exceptionManager, IMappingService mappingService)
            {
                try
                {
    				#region Parameter validation
            ...
            public void DeleteAudit(string currentUser, string user, string appID, string overrideID, string code, string lockID)
            {
    			// Create unit of work
                IUnitOfWork uow = new UnitOfWork(currentUser);
    			...
    			// Call overload with injected objects
                DeleteAudit(currentUser, user, appID, overrideID, code, lockID, dataRepository, uow,exceptionManager, mappingService);
            }
    		...
    		public AuditSearchVMDC SearchAudit(string currentUser, string user, string appID, string overrideID, AuditSearchCriteriaDC searchCriteria, int page, int pageSize)
            {
    			...
    			ISpecification<Audit> specification = new Specification<Audit>();
    			...
    			// Call overload with injected objects
                return SearchAudit(currentUser, user, appID, overrideID, searchCriteria, page, pageSize, specification, dataRepository, uow, exceptionManager, mappingService);
    		}
            ...
            partial void EvaluateSearchCriteria(AuditSearchCriteriaDC searchCriteria, ref ISpecification<Audit> specification);
            ...
            /// <param name="overrideID"></param>
            /// <returns></returns>
            public List<AuditDC> GetAllAudit(string currentUser, string user, string appID, string overrideID)
            {
    			// Create unit of work
                IUnitOfWork uow = new UnitOfWork(currentUser);
                ...
                return GetAllAudit(currentUser, user, appID, overrideID, specification, dataRepository, uow, exceptionManager, mappingService);
            }
        	...
        	/// <param name="code"></param>
        	/// <returns></returns>
            public AuditVMDC GetAudit(string currentUser, string user, string appID, string overrideID, string code)
            {
    			//Create ExceptionManager
    			IExceptionManager exceptionManager = new ExceptionManager();
    			...
    			// Call overload with injected objects
                return GetAudit(currentUser, user, appID, overrideID, code, uow, dataRepository
