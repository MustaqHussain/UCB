...
{
    public partial class JobRoleVM
    {
    	public JobRoleModel JobRoleItem { get; set; }
        ...
        public JobRoleAccessContext AccessContext { get; set; }
    	
    }
    
    public enum JobRoleAccessContext
    {
        Create,
        View,
        Edit
