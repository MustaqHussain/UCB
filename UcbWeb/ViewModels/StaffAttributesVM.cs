...
{
    public partial class StaffAttributesVM
    {
    	public StaffAttributesModel StaffAttributesItem { get; set; }
        ...
        public StaffAttributesAccessContext AccessContext { get; set; }
    	
    }
    
    public enum StaffAttributesAccessContext
    {
        Create,
        View,
        Edit
