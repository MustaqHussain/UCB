...
{
    public partial class ApplicationAttributeVM
    {
    	public ApplicationAttributeModel ApplicationAttributeItem { get; set; }
        ...
        public ApplicationAttributeAccessContext AccessContext { get; set; }
    	
    }
    
    public enum ApplicationAttributeAccessContext
    {
        Create,
        View,
        Edit
