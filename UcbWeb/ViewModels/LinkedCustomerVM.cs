...
{
    public partial class LinkedCustomerVM
    {
    	public LinkedCustomerModel LinkedCustomerItem { get; set; }
        ...
        public LinkedCustomerAccessContext AccessContext { get; set; }
    	
    }
    
    public enum LinkedCustomerAccessContext
    {
        Create,
        View,
        Edit
