...
{
    public partial class AttachmentDataVM
    {
    	public AttachmentDataModel AttachmentDataItem { get; set; }
        ...
        public AttachmentDataAccessContext AccessContext { get; set; }
    	
    }
    
    public enum AttachmentDataAccessContext
    {
        Create,
        View,
        Edit
