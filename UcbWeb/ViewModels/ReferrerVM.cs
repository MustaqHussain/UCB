...
{
    public partial class ReferrerVM
    {
    	public ReferrerModel ReferrerItem { get; set; }
        ...
        public ReferrerAccessContext AccessContext { get; set; }
    	
    }
    
    public enum ReferrerAccessContext
    {
        Create,
        View,
        Edit
