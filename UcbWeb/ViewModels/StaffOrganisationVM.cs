...
{
    public partial class StaffOrganisationVM
    {
    	public StaffOrganisationModel StaffOrganisationItem { get; set; }
        ...
        public StaffOrganisationAccessContext AccessContext { get; set; }
    	
    }
    
    public enum StaffOrganisationAccessContext
    {
        Create,
        View,
        Edit
