...
{
    public partial class AbuseTypeVM
    {
    	public AbuseTypeModel AbuseTypeItem { get; set; }
        ...
        public AbuseTypeAccessContext AccessContext { get; set; }
    	
    }
    
    public enum AbuseTypeAccessContext
    {
        Create,
        View,
        Edit
