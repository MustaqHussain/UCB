...
{
    public partial class StandardReportVM
    {
    	public StandardReportModel StandardReportItem { get; set; }
        ...
        public StandardReportAccessContext AccessContext { get; set; }
    	
    }
    
    public enum StandardReportAccessContext
    {
        Create,
        View,
        Edit
