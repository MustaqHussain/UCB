...
{
    public partial class NarrativeVM
    {
    	public NarrativeModel NarrativeItem { get; set; }
        ...
        public NarrativeAccessContext AccessContext { get; set; }
    	
    }
    
    public enum NarrativeAccessContext
    {
        Create,
        View,
        Edit
