...
{
    public class RequiredEmptyForButtonAttribute : ConditionalAttributeBase, IClientValidatable
    {
        ...
        public IEnumerable<ModelClientValidationRule> GetClientValidationRules(ModelMetadata metadata, ControllerContext context)
        {
            ...
            string depProp = BuildHiddenFieldId(metadata, context as ViewContext);
            string targetValue = (this.ButtonName ?? "").ToString();
        ...
        {
            string depProp = QualifyFieldId(metadata, this.ValidationGroup, viewContext);
