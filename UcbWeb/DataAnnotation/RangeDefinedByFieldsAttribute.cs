...
{
    public class RangeDefinedByFieldsAttribute : ConditionalAttributeBase, IClientValidatable
    {
        ...
        public IEnumerable<ModelClientValidationRule> GetClientValidationRules(ModelMetadata metadata, ControllerContext context)
        {
            ...
            string depPropMin = QualifyFieldId(metadata, DependentMinimumProperty, context as ViewContext);
            string depPropMax = QualifyFieldId(metadata, DependentMaximumProperty, context as ViewContext);
