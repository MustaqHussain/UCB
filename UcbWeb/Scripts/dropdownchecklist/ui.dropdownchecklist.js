...
(function (d) {
    var k = 0;
    d.widget("ech.dropdownchecklist", {
        options: {
            header: !1,
            height: 175,
            minWidth: 225,
        ...
        _create: function () {
            ...
            (this.buttonlabel = d("<span />")).html(b.emptyText).appendTo(a);
            ...
            (this.checkboxContainer = d("<ul />")).attr("role", "listbox").attr("aria-expanded", false).addClass("ui-multiselect-checkboxes ui-helper-reset").appendTo(a);
            this._bindEvents();
            this.refresh(!0);
        ...
        refresh: function (a) {
            ...
            b.find("option").each(function (b) {
                ...
                e += '<li role="listitem" class="' + o + '">';
                e += '<label for="' + b + '" title="' + h + '" class="' + m.join(" ") + '">';
                e += '<input id="' + b + '" name="multiselect_' + i + '" type="' + (c.multiple ? "checkbox" : "radio") + '" value="' + k + '"';
        ...
        update: function () {
            var a = this.options,
                ...
                c = b.filter(":checked"),
                f = c.length,
                a = 0 === f ? a.emptyText : d.isFunction(a.selectedText) ? a.selectedText.call(this, f, b.length, c.get()) : /\d/.test(a.selectedList) && 0 < a.selectedList && f <= a.selectedList ? c.map(function () {
        ...
        _setButtonWidth: function () {
            ...
            if (a > 350) {
                $elem = $(this.element);
                if (!$elem.hasClass("input-full-width") || $elem.hasClass("ignore-select-max-size")) {
                    a = 350;
                }
            }
            this.button.width(a);
        ...
        open: function () {
            ...
            if (!(!1 === this._trigger("beforeopen") || a.hasClass("ui-state-disabled") || this._isOpen)) {
                ...
                this._isOpen = !0;
                this.checkboxContainer.attr("aria-expanded", true)
                this._trigger("open")
            }
        },
        close: function () {
            if (!1 !== this._trigger("beforeclose")) {
                ...
                this._isOpen = !1;
                this.button.focus();
                this.checkboxContainer.attr("aria-expanded", false)
                this._trigger("close")
            }
        },
        enable: function () {
