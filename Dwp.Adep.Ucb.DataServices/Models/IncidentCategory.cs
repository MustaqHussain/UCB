...
{
    public partial class IncidentCategory : IAuditable, IActiveAware 
    {
        ...
        public virtual ICollection<IncidentType> IncidentType
        {
            get
            {
                ...
                {
                    var newCollection = new FixupCollection<IncidentType>();
                    newCollection.CollectionChanged += FixupIncidentType;
                    _incidentType = newCollection;
                }
            ...
            set
            {
                ...
                {
                    var previousValue = _incidentType as FixupCollection<IncidentType>;
                    if (previousValue != null)
                    {
                        previousValue.CollectionChanged -= FixupIncidentType;
                    }
                    _incidentType = value;
                    var newValue = value as FixupCollection<IncidentType>;
                    if (newValue != null)
                    {
                        newValue.CollectionChanged += FixupIncidentType;
                    }
                }
            }
        }
        private ICollection<IncidentType> _incidentType;
        ...
        private void FixupIncidentType(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (e.NewItems != null)
            {
                foreach (IncidentType item in e.NewItems)
                {
                    item.IncidentCategory = this;
                }
            }
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.IncidentCategory, this))
                    {
                        item.IncidentCategory = null;
                    }
                }
            }
        }
