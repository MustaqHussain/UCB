...
namespace Dwp.Adep.Ucb.DataServices
{
    public class Specification<TEntity> : ISpecification<TEntity> where TEntity : class
    {
        ...
        //public IQueryable<TEntity> SatisfyingEntitiesFrom(IQueryable<TEntity> query,Expression<Func<TEntity,object>> sortExpression)
        //{

        //    return query.Where(Predicate).OrderBy(sortExpression);
        //}
